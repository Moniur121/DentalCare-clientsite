...
import './ExpectionalDoctor.css'
import expectional from '../../images/expectional.png';
const ExpectionalDoctor = () => {
    return (
        <div className="homeSection-containerBg">
             <section className="  pb-0 pb-md-5  ">
                <div className="container mb-5 py-5">
                    <div className="row mb-5">
                        <div className="col-md-5 mb-4 m-md-0">
                            <img className="img-fluid" src={expectional} alt="" />
                        </div>
...
export default ExpectionalDoctor;